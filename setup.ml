...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0eb5ffb6546c1efddf2fec0860baa1ff) *)
(*
...
let setup_t =
  {
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("mirage-runtime", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Static_ipv4"; "Ipv4_wire"; "Ipv4_packet"];
                      lib_pack = false;
                      lib_internal_modules = ["Ipv4_common"; "Routing"];
                      lib_findlib_parent = Some "tcpip";
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Tcp_socket"];
                      lib_findlib_parent = Some "tcpip";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("duration", None);
                           FindlibPackage ("mirage-stdlib-random", None);
                           FindlibPackage ("result", None);
                           FindlibPackage ("rresult", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
     ...
     oasis_version = "0.4.8";
     oasis_digest =
       Some "\250`\141\002\251\234;\158\005\228p\149\131\150\174\142";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
