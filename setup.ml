...
(* OASIS_START *)
(* DO NOT EDIT (digest: 87e1f2b28dc4cc99a6c1d5074d3c0567) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Arpv4_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
                      lib_findlib_name = Some "arpv4-unix";
                      lib_findlib_containers = []
                   });
               Library
                 ({
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Icmpv4_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
                      lib_findlib_name = Some "icmpv4-unix";
                      lib_findlib_containers = []
                   });
               Library
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\178BZ\229\180U\132?\145\2052\184\012\024X\018";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
