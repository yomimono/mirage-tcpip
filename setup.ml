...
(* OASIS_START *)
(* DO NOT EDIT (digest: 42d4711c46105ba8e1d22b63656cab46) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Use bisect_ppx to generate coverage data";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("bisect_ppx", None);
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\182\014O\196=\242o\142\1466\218\253\218\200c\203";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
