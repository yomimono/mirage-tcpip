...
(* OASIS_START *)
(* DO NOT EDIT (digest: 46f9a88c9e5fd97f63ae4b3a7566e7b8) *)
(*
...
let setup_t =
  {
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("mirage-types",
                               Some (OASISVersion.VGreaterEqual "2.8.0"));
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ethif"; "Ethif_wire"; "Ethif_packet"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Arpv4"; "Arpv4_wire"; "Arpv4_packet"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
                      lib_findlib_name = Some "arpv4";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ipv4"; "Ipv4_wire"; "Ipv4_packet"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ipv6"; "Ndpv6"; "Ipv6_wire"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Icmpv4"; "Icmpv4_packet"; "Icmpv4_wire"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
                      lib_findlib_name = Some "icmpv4";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Udp"; "Udp_wire"; "Udp_packet"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Tcpip_stack_direct"; "Tcpip_transport_direct"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Icmpv4_socket"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
                      lib_findlib_name = Some "icmpv4-socket";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Udp_socket"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
                      lib_findlib_name = Some "udp-socket";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Tcp_socket"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
                      lib_findlib_name = Some "tcp-socket";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("io-page.unix", None);
                           FindlibPackage ("logs", None);
                           InternalLibrary "udp-socket";
                           InternalLibrary "tcp-socket"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "ethif";
                           InternalLibrary "arpv4";
                           InternalLibrary "ipv4";
                           InternalLibrary "tcp";
                           InternalLibrary "udp";
                           InternalLibrary "tcpip-direct";
                           InternalLibrary "icmpv4";
                           InternalLibrary "udp-socket";
                           InternalLibrary "tcp-socket";
                           InternalLibrary "tcpip-stack-socket";
                           FindlibPackage ("duration", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "B\193\138]\183Is\003\146\019\012\174\198\152\014(";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
